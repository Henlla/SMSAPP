...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        if (remoteMessage.getNotification() != null) {
            ...
            }else if(data.getAction().equals("Attendance")){
                sendNotificationAttendance(data.getContent(), remoteMessage.getNotification().getTitle());
            }
        }
    }

    private void sendNotificationAttendance(String content, String title) {
